  ...
  },
{
  ...
  },
  {
    ...
    synonyms: [],
    antonyms: [],
    roots: ["stru", "stroy", "stroy destroy (put an end to by attacking)", "instruct (to teach)", "industry (manufacturing activity)", "obstruct (impede) Don\u2019t confuse with"],
    confusedWith: [],
    level: 4
  },
  {
  ...
  },
  {
    ...
    definition: "isolated from cultural and intellectual influences outside one’s own experience; insularity = the quality of being culturally isolated",
  ...
  },
  {
    ...
    definition: "conforming strictly to traditional teachings",
  ...
  },
  {
    ...
    confusedWith: ["abdicate = to step down from a position of power"],
    level: 4
  },
  {
    id:  '58',
  ...
  },
  {
    ...
    exampleSentence: "The scientists could not substantiate their hypothesis, because they could not replicate the results of their experiment.",
  ...
  },
  {
    ...
    definition: "to escape or avoid, usually through clever means",
    exampleSentence: "The fighter pilot was able to evade the missile with his deft maneuvers.",
    synonyms: ["elude", "avoid", "skirt"],
    antonyms: [],
    roots: ["vad", "vas invade (to intrude on a region and occupy it)"],
    confusedWith: ["invade (to intrude on a region and occupy it)"],
    level: 1
  },
  {
    id:  '130',
  ...
  },
  {
    ...
    definition: "to give up or put aside publicly",
    exampleSentence: "He renounced his membership in the club when he heard that it would not allow women as members.",
    synonyms: [],
    antonyms: [],
  ...
  },
  {
    ...
    definition: "to denounce someone bitterly",
    exampleSentence: "After her callous remarks about the poor, Michelle was vilified in the press.",
  ...
  },
  {
    ...
    definition: "a leader who persuades followers through emotional populist appeal rather than rational argument; demagoguery = speechmaking by a political leader that appeals to popular prejudices",
    exampleSentence: "The nation had grown tired of its demagogues and elected a well-educated technocrat as its new leader",
    synonyms: [],
    antonyms: [],
  ...
  },
  {
    ...
    definition: "lacking in self-confidence; shy and modest; diffidence = lack of self-confidence",
    exampleSentence: "Kate had to overcome her natural diffidence in order to audition for the musical.",
    synonyms: [],
    antonyms: [],
    roots: ["fid fidelity (faithfulness)", "confidence (faith in oneself)"],
    confusedWith: ["indifferent (lacking concern), different, deferent (respectful of the authority of others)"],
    level: 3
  },
  {
    id:  '159',
  ...
  },
  {
    ...
    definition: "to quell the agitation of something; to make peaceful; pacifist = one who advocates for peace rather than war",
    exampleSentence: "The lullaby seemed to pacify the crying baby.",
  ...
  },
  {
    ...
    definition: "easily managed or influenced; intractable = difficult to manage",
    exampleSentence: "The children proved to be more tractable after they had been given their afternoon snack.",
    synonyms: [],
    antonyms: [],
  ...
  },
  {
    ...
    definition: "a published collection of writings",
    exampleSentence: "Several of the poems in the anthology were chosen for national awards.",
    synonyms: [],
    antonyms: [],
    roots: [],
    confusedWith: [],
  ...
  {
    id:  '227',
    text: "irreverent (adj) ir- not + re- (intensive) + vereri to respect showing no respect for things that are ordinarily given respect; reverent = very respectful",
    definition: "showing no respect for things that are ordinarily given respect",
    exampleSentence: "Comedy troupe performed an irreverent sketch that thoroughly insulted the Vice President.",
  ...
  },
  {
    ...
    definition: "intended to punish; impunity = exemption from punishment",
    exampleSentence: "The court imposed punitive damages to discourage such reckless behavior in the future.",
    ...
    confusedWith: ["immunity (the ability to resist infection) or impugn (to attack as invalid)"],
    level: 2
  },
  {
    id:  '230',
  ...
  },
  {
    ...
    exampleSentence: "Paul always embellishes his stories with false intrigue.",
  ...
  },
  {
    ...
    definition: "extreme reluctance to spend money, use unnecessary language, or expend resources; parsimonious (adj) = extremely reluctant to spend money, use unnecessary language, or expend resources",
    exampleSentence: "Mastering the art of haiku requires mastering the art of parsimony.",
    synonyms: [],
    antonyms: [],
    roots: [],
    confusedWith: [],
  ...
  },
  {
    ...
    definition: "improvised; performed without preparation; extemporize (v) = to improvise",
    exampleSentence: "The senator’s extemporaneous speech was surprisingly coherent and very well received.",
    synonyms: [],
    antonyms: [],
  ...
  },
  {
    ...
    definition: "the force that makes something move or energizes a process",
    exampleSentence: "The coach’s speech provided the impetus for the team to redouble its efforts in the second half.",
    synonyms: [],
    antonyms: [],
    ...
    confusedWith: ["impious (not devoutly religious)", "impish (mischievous)"],
    level: 3
  },
  {
    id:  '269',
  ...
  },
  {
    id:  '281',
    text: "languish (v)",
    definition: "to lack energy; to grow weak",
    exampleSentence: "My favorite baseball team has been languishing in last place for two weeks now.",
    synonyms: ["atrophy", "wither"],
    antonyms: [],
    roots: [],
    confusedWith: ["language (a symbolic means of communication)", "anguish (great distress)"],
    level: 4
  },
  {
    id:  '282',
  ...
  },
  {
    ...
    definition: "(of a pool of water or the air in a confined space) unmoving and hence having an unpleasant smell; sluggish",
    exampleSentence: "The stagnant air of the gym made us feel sick.",
    synonyms: [],
    antonyms: [],
  ...
  },
  {
    ...
    definition: "to make correct; to put right",
    exampleSentence: "The journalist rectified her error by publishing a retraction.",
  ...
  },
  {
    ...
    definition: "unskilled; clumsy; ineptitude = clumsiness; lack of skill",
    exampleSentence: "Todd’s awkward joke was a sincere but inept attempt to lighten the mood.",
  ...
  },
  {
    ...
    definition: "characterized by or guilty of betrayal; hazardous; treachery = abject betrayal",
    exampleSentence: "Benedict Arnold’s treacherous actions are etched in our national history.",
    synonyms: ["perilous", "precarious"],
    antonyms: [],
    roots: [],
    confusedWith: ["tortuous (full of twists and turns)", "lecherous (showing excessive sexual desire), trenchant (cutting and incisive)"],
    level: 1
  },
  {
    id:  '310',
  ...
  },
  {
    ...
    exampleSentence: "He was assiduous in his research, checking every reference and tracing its history.",
  ...
  },
  {
    ...
    exampleSentence: "The intrepid explorers set out for the summit.",
  ...
  },
  {
    ...
    definition: "evil intent; malevolent = with evil intent",
    exampleSentence: "The villain eyed his victim with malevolence.",
  ...
  },
  {
    ...
    definition: "conducive to success; favorable to a positive outcome; inauspicious = not favorable",
    exampleSentence: "The rainstorm did not provide an auspicious start to the wedding ceremony.",
  ...
  },
  {
    ...
    exampleSentence: "Lisa’s office mates became solicitous when they heard that her daughter was ill.",
    synonyms: [],
    antonyms: [],
  ...
  },
  {
    ...
    definition: "tending to spend resources wastefully; prodigality = wastefulness",
    exampleSentence: "A prodigal manager can squander a year’s worth of careful savings in just a few weeks.",
  ...
  },
  {
    id:  '403',
    text: "abash (v)",
    definition: "to cause to feel embarrassed or ashamed; abashed = embarrassed, unabashed = confidently unashamed Don\u2019t confuse with",
    exampleSentence: "I was abashed at the sight of her photograph.",
    synonyms: [],
    antonyms: [],
    roots: [],
    confusedWith: ["bash ((v) hit forcefully; (n) a lively party)"],
    level: 3
  },
  {
    id:  '404',
